...
// This component is typically used to render custom content for tooltips in data visualization libraries (e.g., Recharts)
const CustomTooltipContent = ({ active, payload, dataKey }) => {
    ...
    if (active && payload && payload.length) {
        // If the conditions are met, render the custom tooltip content
